...
namespace Mozlite.Data.Sqlite.Migrations
{
    ...
    /// Sqlite数据库迁移SQL生成类。
    /// </summary>
    public class MigrationsSqliteGenerator : MigrationsSqlGenerator
    {
        ...
        public MigrationsSqliteGenerator(ISqlHelper sqlHelper, ITypeMapper typeMapper, IExpressionVisitorFactory visitorFactory)
