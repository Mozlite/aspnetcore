...
namespace Mozlite.Data.Sqlite.Query
{
    ...
    /// Sqlite条件表达式访问工厂实现类。
    /// </summary>
    public class SqliteExpressionVisitorFactory : IExpressionVisitorFactory
    {
        ...
        /// <summary>
        /// 初始化类<see cref="SqliteExpressionVisitorFactory"/>。
        /// </summary>
        ...
        public SqliteExpressionVisitorFactory(ISqlHelper sqlHelper, ITypeMapper typeMapper, IMemberTranslator memberTranslator, IMethodCallTranslator methodCallTranslator, IExpressionFragmentTranslator fragmentTranslator)
        {
        ...
        {
            return new SqliteExpressionVisitor(_sqlHelper, _typeMapper, _memberTranslator, _methodCallTranslator, _fragmentTranslator);
        }
        ...
        {
            return new SqliteExpressionVisitor(_sqlHelper, _typeMapper, _memberTranslator, _methodCallTranslator, _fragmentTranslator, delimiter);
        }
    }
}