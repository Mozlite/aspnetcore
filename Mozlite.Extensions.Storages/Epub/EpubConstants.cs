namespace Mozlite.Extensions.Storages.Epub
{
    ...
    internal class EpubConstants
    {
        ...
        /// </summary>
        public static readonly string Container = @"<?xml version=""1.0""?>
  ...
  <rootfiles>
    <rootfile full-path=""OEBPS/content.opf""
     media-type=""application/oebps-package+xml"" />
        ...
        /// HTML默认模板。
        /// </summary>
        public static string Html(string title, string body) => $@"<?xml version=""1.0"" encoding=""utf-8"" standalone=""no""?>
