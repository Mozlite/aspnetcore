...
namespace Mozlite.Extensions.Storages
{
    ...
    /// 存储文件夹清理服务。
    /// </summary>
    public class StorageClearTaskExecutor : TaskService
    {
        private readonly IStorageDirectory _storageDirectory;
        /// <summary>
        /// 初始化类<see cref="StorageClearTaskExecutor"/>。
        /// </summary>
        /// <param name="storageDirectory">存储文件夹接口。</param>
        public StorageClearTaskExecutor(IStorageDirectory storageDirectory)
        {
