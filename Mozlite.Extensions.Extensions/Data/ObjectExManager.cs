...
namespace Mozlite.Extensions.Data
{
    ...
    public abstract class ObjectExManager<TModel, TKey> : IObjectExManager<TModel, TKey>
        where TModel : IIdSiteObject<TKey>, IIdObject<TKey>
    {
        ...
        /// <summary>
        /// 初始化类<see cref="ObjectExManager{TModel,TKey}"/>。
        /// </summary>
    ...
    public abstract class ObjectExManager<TModel> : ObjectExManager<TModel, int>, IObjectExManager<TModel>
