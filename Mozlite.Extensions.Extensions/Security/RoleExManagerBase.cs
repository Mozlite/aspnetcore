...
namespace Mozlite.Extensions.Security
{
    ...
    public abstract class RoleExManagerBase<TRole, TUserRole, TRoleClaim>
        : RoleManagerBase<TRole, TUserRole, TRoleClaim>, IRoleExManager<TRole, TUserRole, TRoleClaim>
        ...
        where TRoleClaim : RoleClaimBase, new()
    {
        ...
        /// <summary>
        /// 初始化类<see cref="RoleExManagerBase{TRole,TUserRole,TRoleClaim}"/>
        /// </summary>
        ...
        protected RoleExManagerBase(IRoleStore<TRole> store, IEnumerable<IRoleValidator<TRole>> roleValidators, ILookupNormalizer keyNormalizer, IdentityErrorDescriber errors, ILogger<RoleManager<TRole>> logger, IMemoryCache cache, ISiteContextAccessorBase siteContextAccessor)
