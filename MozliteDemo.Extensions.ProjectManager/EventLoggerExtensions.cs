...
namespace MozliteDemo.Extensions.ProjectManager
{
    ...
    public static class EventLoggerExtensions
    {
        ...
        /// <param name="message">事件消息。</param>
        public static void LogUserResult(this IEventLogger logger, DataResult result, string message) => logger.LogResult(result, Resources.EventType, message);
        ...
        /// <param name="message">事件消息。</param>
        /// <param name="args">格式化参数。</param>
        public static void LogUserResult(this IEventLogger logger, DataResult result, string message, params object[] args) => logger.LogResult(result, Resources.EventType, message, args);
        ...
        /// <param name="result">数据操作结果。</param>
        /// <param name="message">事件消息。</param>
        public static Task LogUserResultAsync(this IEventLogger logger, DataResult result, string message) => logger.LogResultAsync(result, Resources.EventType, message);
        ...
        /// <param name="message">事件消息。</param>
        /// <param name="args">格式化参数。</param>
        public static Task LogUserResultAsync(this IEventLogger logger, DataResult result, string message, params object[] args) => logger.LogResultAsync(result, Resources.EventType, message, args);
    }
}