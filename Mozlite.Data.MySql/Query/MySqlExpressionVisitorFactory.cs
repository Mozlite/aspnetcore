...
namespace Mozlite.Data.MySql.Query
{
    ...
    /// </summary>
    public class MySqlExpressionVisitorFactory : IExpressionVisitorFactory
    {
        ...
        /// <summary>
        /// 初始化类<see cref="MySqlExpressionVisitorFactory"/>。
        /// </summary>
        ...
        public MySqlExpressionVisitorFactory(ISqlHelper sqlHelper, ITypeMapper typeMapper, IMemberTranslator memberTranslator, IMethodCallTranslator methodCallTranslator, IExpressionFragmentTranslator fragmentTranslator)
        {
        ...
        {
            return new MySqlExpressionVisitor(_sqlHelper, _typeMapper, _memberTranslator, _methodCallTranslator, _fragmentTranslator);
        }
        ...
        {
            return new MySqlExpressionVisitor(_sqlHelper, _typeMapper, _memberTranslator, _methodCallTranslator, _fragmentTranslator, delimiter);
        }
    }
}