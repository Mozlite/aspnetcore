...
namespace Mozlite.Data.MySql.Query
{
    ...
    /// SQLServer表达式解析器。
    /// </summary>
    public class MySqlExpressionVisitor : SqlExpressionVisitor, IMySqlExpressionVisitor
    {
        /// <summary>
        /// 初始化类<see cref="MySqlExpressionVisitor"/>。
        /// </summary>
        ...
        public MySqlExpressionVisitor(ISqlHelper sqlHelper, ITypeMapper typeMapper, IMemberTranslator memberTranslator, IMethodCallTranslator methodCallTranslator, IExpressionFragmentTranslator fragmentTranslator) 
        ...
        public MySqlExpressionVisitor(ISqlHelper sqlHelper, ITypeMapper typeMapper, IMemberTranslator memberTranslator, IMethodCallTranslator methodCallTranslator, IExpressionFragmentTranslator fragmentTranslator, Func<Type, string> schemaFunc)
