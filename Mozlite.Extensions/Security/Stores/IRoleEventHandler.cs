...
namespace Mozlite.Extensions.Security.Stores
{
        ...
        where TRole : RoleBase
    {
        ...
        bool OnCreate(IDbTransactionContext<TRole> context);
        ...
        /// <returns>返回操作结果，返回<c>true</c>表示操作成功，将自动提交事务，如果<c>false</c>或发生错误，则回滚事务。</returns>
        Task<bool> OnCreateAsync(IDbTransactionContext<TRole> context, CancellationToken cancellationToken = default(CancellationToken));
