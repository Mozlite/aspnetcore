...
namespace Mozlite.Extensions.Sites
{
    ...
    public interface ISiteManager : ISingletonService
    {
        ...
        IEnumerable<SiteSettings> LoadSites();
        ...
        /// </summary>
        /// <returns>返回所有网站。</returns>
        Task<IEnumerable<SiteSettings>> LoadSitesAsync();
        ...
        DataResult Save(SiteSettings siteSettings);
        ...
        /// <param name="siteSettings">当前配置实例。</param>
        /// <returns>返回数据结果。</returns>
        Task<DataResult> SaveAsync(SiteSettings siteSettings);
        ...
        /// <param name="domain">当前域名。</param>
        /// <returns>返回当前网站配置。</returns>
        Task<TSiteSettings> GetSiteSettingsAsync<TSiteSettings>(string domain) where TSiteSettings : SiteSettings, new();
        ...
        /// <param name="settingsId">配置ID。</param>
        /// <returns>返回当前网站配置。</returns>
        Task<TSiteSettings> GetSiteSettingsAsync<TSiteSettings>(int settingsId) where TSiteSettings : SiteSettings, new();
    }
}